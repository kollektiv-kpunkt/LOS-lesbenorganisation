...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210515_1754_los_836e2e58f40dc3495773_20210515155450_archive.zip';
	const ARCHIVE_SIZE		 = '38685538';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '836e2e5-15155450';
    const SECONDARY_PACKAGE_HASH = 'bfc664c-15155450';
	const VERSION			 = '1.4.0';
