...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210516_2322_los_a607284f7e7a2a417099_20210516212223_archive.zip';
	const ARCHIVE_SIZE		 = '78332422';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a607284-16212223';
    const SECONDARY_PACKAGE_HASH = 'cf809e0-16212223';
	const VERSION			 = '1.4.0';
